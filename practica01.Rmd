...
+ Antes de seguir adelante asegúrate de que en RStudio está abierto el proyecto 

+ Descarga ahora el fichero  Rmarkdown llamado \link{Nope}{practica01\_apellidos\_nombre.Rmd}. **Recuerda:** usa el código con `download.file`, no hagas la descarga con el navegador. 
