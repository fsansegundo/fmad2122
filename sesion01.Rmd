...
1. Crea una cuenta en [GitHub](https://github.com). **IMPORTANTE:** debes utilizar tu dirección de correo electrónico de la universidad.
2. **Lee el siguiente enlace antes de elegir un nombre de usuario**.   
[Happy Git: username-advice](https://happygitwithr.com/github-acct.html#username-advice)  
Es imprescindible que envíes a tu profesor el nombre de usuario que hayas elegido lo antes posible.  
3. Instala Git en tu ordenador si aún no lo has hecho. Sigue las instrucciones de [este enlace](https://happygitwithr.com/install-git.html#install-git).
